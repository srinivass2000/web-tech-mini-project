        ...
        <html lang="en">
            ...
            <body>
                <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
                    ...
                    We at Sarlon Zuva have the best equipments in the market
                        </h2>
                        ...
                        <xsl:for-each select="team/members">
                            <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                                <div class="w-full md:w-2/5 h-80">
                                    <img class="object-center object-cover w-full h-full" src="<xsl:value-of select=" link" />"></img>
                                </div>
